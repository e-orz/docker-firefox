> NOTE: This is a fork of the original repository modified to use firefox-esr 45.9.0. It's pushed to docker hub. See this [link](https://hub.docker.com/r/eorz/firefox "Docker Hub image location") for details.
